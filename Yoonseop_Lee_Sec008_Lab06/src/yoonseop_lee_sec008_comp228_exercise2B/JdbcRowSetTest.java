package yoonseop_lee_sec008_comp228_exercise2B;
...
// final String DATABASE_URL = "jdbc:oracle:thin:@199.212.26.208:1521:SQLD";
   ...
   public static void main(String args[]) {
      ...
      try (JdbcRowSet rowSet = RowSetProvider.newFactory().createJdbcRowSet())            
         ...
         rowSet.setCommand("SELECT ISBN, title FROM titles where EditionNumber > 6 and EditionNumber < 10 ORDER BY ISBN");
